...
def main() -> None:
    parser = build_parser(
        ...
        default_loss_cfg="configs/loss/stage2_hybrid.yaml",
        default_train_cfg="configs/train/stage2_hybrid.yaml",
        default_init_from="outputs/runs/stage1_param_only/best.pt",
    )
